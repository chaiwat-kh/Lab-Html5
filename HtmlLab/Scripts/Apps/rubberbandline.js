...
canvas.onmousemove = function (e) {
    ...
    if (objecttype === 'erase') {
        ...
        context.fillRect(loc.x - ERASE_WIDHT / 2, loc.y - ERASE_WIDHT / 2, 20, 20);
        context.strokeRect(loc.x - ERASE_WIDHT / 2, loc.y - ERASE_WIDHT / 2, 20, 20);
    }
    ...
    if (dragging) {
        ...
        if (objecttype === 'draw') {
            ...
            context.beginPath();
            context.clearRect(loc.x - ERASE_WIDHT / 2, loc.y - ERASE_WIDHT / 2, 20, 20);
            saveDrawingSurface();
        }
    }
}
