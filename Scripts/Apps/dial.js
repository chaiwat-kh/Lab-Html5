var canvas = document.getElementById('canvas'),
    ...
    function drawTick(angle, radius, cnt) {
        ...
        context.moveTo(circle.x + radius * Math.cos(angle), circle.y + radius * Math.sin(angle));
        context.lineTo(circle.x + (radius - tickWidth) * Math.cos(angle), circle.y + (radius - tickWidth) * Math.sin(angle));
        context.stroke();
    }
